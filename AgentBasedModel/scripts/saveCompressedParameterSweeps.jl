...
titleStr = "../simulations/compressedSims/$simulationNameFull/behavMeansAll α = $αrange , β = $βrange , λ = $λrange .jld"
save(titleStr,"behavMeansAll", behavMeansAll)
titleStr = "../simulations/compressedSims/$simulationNameFull/attMeansAll α = $αrange , β = $βrange , λ = $λrange .jld"
save(titleStr,"attMeansAll", attMeansAll)

println("saved α = $αrange , β = $ββ , λ = $λrange ")
